...
## Copyright (C) 2001-2012 Cédrick FAURY
...
###################################################################################################
##
##  Un SpinCtrl pour nombres réels !
##
###################################################################################################  
#class RealSpinCtrl(wx.Panel):
#    """ Un SpinCtrl pour nombres réels !
#        nombre : un réel
#        coef : le coefficient pour l'évolution de <nombre>
#        mode : "log" => nombre = nombre */ coef
#            ou "fix" => nombre = nombre +- coef
#    """
#    def __init__(self, parent, nombre, coef = 1.1, mode = "log", 
#                 help = "", sizeh = -1):
#        wx.Panel.__init__(self, parent, -1)
#        
#        self.nombre = nombre
...
#        # Valeur de la variable
#        #
#        self.text = wx.TextCtrl(self, -1, self.lstToText(self.nombre), size = (-1, sizeh))#,
#        
#        if len(help) > 0:
...
##        print "SpinUp", self.coef
#        if self.mode == "log":
#            self.nombre = self.nombre * self.coef
#        else:
#            self.nombre = self.nombre + self.coef
#        self.sendEvent()
#        
...
def setToggled(bmp, back):
    ...
    memdc.SetBackground(wx.Brush(wx.Colour(200,200,255)))
    memdc.Clear()
